  ...
  const stats = useMemo(() => {
    ...
    const averageIntensity =
      moods.length > 0
        ? (
            moods.reduce(
              (sum, mood) => sum + Number(mood.intensity || 0),
              0
            ) / moods.length
          ).toFixed(1)
        : '0.0'
    ...
    const practicedSkills = skills.reduce(
      (sum, skill) => sum + Number(skill.practiced_count || 0),
      0
    )
    ...
    <div className="statistics-page">
      ...
      <section className="statistics-hero">
        <div>
          ...
          <p>
            A clear overview of your mood history,
            journal activity and coping skill progress.
          </p>
        </div>
      </section>
        ...
        <article className="statistics-panel">
          ...
          {stats.topMood ? (
            <div className="top-mood-box">
              ...
              <p>
                This mood appears most often in your tracked entries
                with <strong>{stats.topMood[1]}</strong> check-ins.
              </p>
